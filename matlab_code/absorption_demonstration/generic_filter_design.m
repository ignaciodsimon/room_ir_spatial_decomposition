function [filtered_signal, group_delay] = generic_filter_design(input_signal, bands_frequencies, bands_levels)
...
%     semilogx(interpolated_bands_levels(:,1), interpolated_bands_levels(:,2))
%     hold on
%     semilogx(bands_frequencies, bands_levels)
%     grid
%     return
