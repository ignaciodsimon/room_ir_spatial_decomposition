function rectangular_room_geometry(display_geometry)
    % Generates the definitions file needed to execute the simulation. The
    % room created is a rectangle with four different materials (wall,
    % wood, door, window).
    %
    % Joe.
    ...
    save('rectangular_room_geometry.mat', 'include_real_source', 'max_reflection_order', ...
    ...
    % Show generated room
    if display_geometry
        display_geometry_from_file('rectangular_room_geometry.mat');
    end
end
